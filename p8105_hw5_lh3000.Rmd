...
The raw dataset contains information about criminal homicides in 50 large U.S. cities from 2012 to 2017, collected by The Washington Post. The variable included are the location of the killing, whether an arrest was made and, in most cases, basic demographic information about each victim.
...
1) Make a plot showing the average estimate of µ-hat vs. the true value of µ.


2) Make a plot showing the average estimate of µ-hat only in samples for which the null was rejected vs. the true value of µ.
